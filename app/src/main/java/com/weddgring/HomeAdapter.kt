...
import com.weddgring.pojo.UserDataPojo

class HomeAdapter(var context: Context, var userListPojo: ArrayList<UserDataPojo>,var recycleViewClickListner: RecycleViewClickListner) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.place.setText("Place- "+userListPojo.get(position).fullname)
